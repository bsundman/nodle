//! MaterialX context for material authoring and shading workflows
...
impl Context for MaterialXContext {
    ...
    fn get_menu_structure(&self) -> Vec<ContextMenuItem> {
        ...
        crate::menu_hierarchy::GlobalMenuHierarchy::get_materialx_context_menu()
    }
    ...
    fn create_context_node(&self, node_type: &str, position: Pos2) -> Option<Node> {
        ...
        match node_type {
            ...
            "MaterialX_ShaderContext" => Some(materialx::utilities::create_shader_context_node(position)),
