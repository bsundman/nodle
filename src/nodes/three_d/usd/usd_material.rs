...
impl NodeFactory for USDMaterial {
    fn metadata() -> NodeMetadata {
        NodeMetadata {
            node_type: "USD_Material",
            display_name: "USD Material",
            category: NodeCategory::new(&["3D", "USD", "Materials"]),
            description: "Creates a USD Material primitive for shading",
            color: Color32::from_rgb(150, 100, 200), // Purple for materials
            inputs: vec![
...
impl NodeFactory for USDPreviewSurface {
    fn metadata() -> NodeMetadata {
        NodeMetadata {
            node_type: "USD_PreviewSurface",
            display_name: "Preview Surface",
            category: NodeCategory::new(&["3D", "USD", "Shaders"]),
            description: "Creates a USD Preview Surface shader (PBR)",
            color: Color32::from_rgb(100, 150, 200), // Blue for shaders
            inputs: vec![
                PortDefinition::required("Stage", DataType::Any)
                    .with_description("USD Stage reference"),
                PortDefinition::required("Path", DataType::String)
...
impl NodeFactory for USDTexture {
    fn metadata() -> NodeMetadata {
        NodeMetadata {
            node_type: "USD_Texture",
            display_name: "USD Texture",
            category: NodeCategory::new(&["3D", "USD", "Textures"]),
            description: "Creates a USD Texture node (UsdUVTexture)",
            color: Color32::from_rgb(200, 150, 50), // Orange for textures
            inputs: vec![
                PortDefinition::required("Stage", DataType::Any)
                    .with_description("USD Stage reference"),
                PortDefinition::required("Path", DataType::String)
